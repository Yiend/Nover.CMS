...
import * as Plugin_2 from 'D:/GitHubCode/NoverSolutions/Nover.CMS/react-web/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'D:/GitHubCode/NoverSolutions/Nover.CMS/react-web/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
