...
import type { RequestInterceptor, ResponseInterceptor, ResponseError } from 'umi-request';
...
// 请求拦截
const requestInterceptor: RequestInterceptor = (url: string, options: RequestInit) => {
  // 如果是登录地址，直接返回，不添加请求参数
