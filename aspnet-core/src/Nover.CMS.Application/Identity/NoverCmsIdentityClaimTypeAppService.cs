...
{
    [RemoteService(false)]
    [Authorize(NoverCmsIdentityPermissions.ClaimTypes.Default)]
    public class NoverCmsIdentityClaimTypeAppService : IdentityAppServiceBase, INoverCmsIdentityClaimTypeAppService
    {
        protected IdentityClaimTypeManager IdenityClaimTypeManager { get; }
        protected IIdentityClaimTypeRepository IdentityClaimTypeRepository { get; }

        public NoverCmsIdentityClaimTypeAppService(IdentityClaimTypeManager idenityClaimTypeManager, IIdentityClaimTypeRepository identityClaimTypeRepository)
        {
        ...
        [Authorize(NoverCmsIdentityPermissions.ClaimTypes.Create)]
        ...
        [Authorize(NoverCmsIdentityPermissions.ClaimTypes.Update)]
        ...
        [Authorize(NoverCmsIdentityPermissions.ClaimTypes.Delete)]
